...
<li id="li2" onclick="changeActive('li2')"><a href="<%=request.getContextPath()%>/selectAllHousehold">住户信息管理</a></li>
<li id="li3" onclick="changeActive('li3')"><a href="#">物业缴费信息管理</a></li>
