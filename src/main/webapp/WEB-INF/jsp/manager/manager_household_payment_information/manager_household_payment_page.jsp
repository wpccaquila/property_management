                    ...
                    <div class="panel-body">
                        <form  method="post">
                            <table class="table table-bordered">
                                ...
                                <c:forEach items="${householdPaymentInfoList}" var="item" varStatus="status">
                                    <tr>
                                        <td>
                                                <%-- 是数据库中的行号，不是id号--%>
                                        ...
                                        <td>
                                            <a href="<%=request.getContextPath()%>/forwardUpdateHouseholdPage?propertyPaymentId=${item.propertyPaymentId}"  class="btn btn-primary">修改数据</a>
                                            <a class="btn btn-primary"  href="javascript:deleteData('<%=request.getContextPath()%>/deleteHouseholdById?propertyPaymentId=${item.propertyPaymentId}')">删除用户</a>
                                        </td>
                                    </tr>
                                </c:forEach>
                                </tbody>
...
<%--                        <%@ include file="householdPayment_paging_button.jsp"%>--%>
<%--                    </ul>--%>
<%--                </div>--%>
