                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="owner_identity" id="inlineRadio1" value="业主"  <c:if test="${requestScope.ownerInfo.owner_identity == '业主'}">checked</c:if>>
                                    <label class="form-check-label" for="inlineRadio1">业主</label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="owner_identity" id="inlineRadio2" value="租客" <c:if test="${requestScope.ownerInfo.owner_identity == '租客'}">checked</c:if>>
