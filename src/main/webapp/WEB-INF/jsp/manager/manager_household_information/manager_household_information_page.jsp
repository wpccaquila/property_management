                                ...
                                <c:forEach items="${householdInfoList}" var="item" varStatus="status">
                                    <tr>
                                        <td>
                                            ...
                                            <input type="text" readonly="readonly" name="owner_id" value="${householdStartLineNo}" class="form-control" />
                                        </td>
                                        <td>
                                            <input type="text" readonly="readonly" name="owner_name" value="${item.householdName}" class="form-control" />
                                        </td>
                                        <td>
                                            <input type="text" readonly="readonly" name="owner_phone" value="${item.householdIdNumber}" class="form-control" />
                                        </td>
                                        <td>
                                            <input type="text" readonly="readonly" name="owner_address" value="${item.householdBirthday}" class="form-control" />
                                        </td>
                                        <td>
                                            <input type="text" readonly="readonly" name="owner_password" value="${item.householdGender}" class="form-control" />
                                        </td>
                                        <td>
                                            <input type="text" readonly="readonly" name="owner_identity" value="${item.householdPhone}" class="form-control" />
                                        </td>
                                        <td>
                                            <input type="text" readonly="readonly" name="owner_identity" value="${item.householdCheckinTime}" class="form-control" />
                                        </td>
                                        <td>
                                            <input type="text" readonly="readonly" name="owner_identity" value="${item.householdHouseType}" class="form-control" />
                                        </td>
                                        <td>
                                            <input type="text" readonly="readonly" name="owner_identity" value="${item.householdAddress}" class="form-control" />
                                        </td>
                                        <td>
